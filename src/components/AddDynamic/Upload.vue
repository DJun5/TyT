            ...
            <div class="thumbnails my-gallery">
              <!--------选择好照片的展示------------->
                <figure itemprop="associatedMedia" itemscope  class="thumbnail" v-for="(item,index) in files" :key="index">
                  ...
                  <mu-button class="file-remove" icon  @click="remove(index,$event)">
                    <mu-icon  value="clear" :size="15" color="#bdbdbd"></mu-icon >
                  </mu-button>
                </figure>
              <!---------上传照片的展示--------->
                <section class="thumbnail" v-if="this.files.length<9"  >
                  <div class="add"  @click="openBotttomSheet" >
                   <mu-icon class="camera" value="camera_alt" :size="52" color="#bdbdbd"></mu-icon>
                  </div>
                </section>
